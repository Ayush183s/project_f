...
def browse_file():
    ...
    global user_input
    user_input = simpledialog.askstring("Region", "Enter region name to listen regional songs:")
    label=get_emotion()
    ...
    if label=="neutral":
           ...
           # label1="natural"
            ...
            print("Scared")
            #label1="sad"
    path_emotion="C:/Users/sarod/OneDrive/Desktop/Project_Final/Playlist New/"
    path="C:/Users/sarod/OneDrive/Desktop/Project_Final/Playlist New/"+label+"/"
